...
loot spawn ~.5 ~.1 ~.5 loot ore_crops:items/quartz_wart
particle minecraft:firework ~0.5 ~ ~0.5 0.1 0.1 0.1 0 10
playsound block.wart_block.break block @a[distance=..50]
advancement grant @p only ore_crops:renewable_hell
advancement grant @p only ore_crops:renewable_quartz
