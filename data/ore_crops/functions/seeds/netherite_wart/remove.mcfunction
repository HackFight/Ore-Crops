...
execute if score #result ore_crops.data matches 1.. run loot spawn ~ ~ ~ loot ore_crops:items/netherite_wart
execute if score #result ore_crops.data matches 2.. run loot spawn ~ ~ ~ loot ore_crops:drops/netherite
