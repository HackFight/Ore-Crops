...
execute if score #result ore_plants.data matches 1.. run loot spawn ~ ~ ~ loot ore_plants:items/quartz_seeds
execute if score #result ore_plants.data matches 2.. run loot spawn ~ ~ ~ loot ore_plants:drops/quartz
